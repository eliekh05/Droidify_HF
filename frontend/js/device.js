          ...
          return `<div class="column is-6-mobile is-4-tablet" data-aos="fade-up" data-aos-delay="${Math.min(i,6)*40}">
            <div class="card">
              <div class="card-content">
                ...
                ${dl?`<a href="${esc(dl)}" target="_blank" rel="noopener" style="font-size:.78rem;color:var(--accent)">Download →</a>`:''}
              </div>
            </div>
          </div>`;
        }).join('')
      ...
      `<div class="column is-6-mobile is-4-tablet" data-aos="fade-up" data-aos-delay="${i*40}">
        <div class="card">
          <div class="card-content">
            ...
            <a href="${esc(f.download_url)}" target="_blank" rel="noopener" style="font-size:.78rem;color:var(--accent)">Download on SamFW →</a>
          </div>
        </div>
      </div>`
    ).join('');
